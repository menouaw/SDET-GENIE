...
async def test_recordings():
    """Test if recordings are being saved correctly."""
    ...
    try:
        # Create a browser profile with recording parameters
        ...
        print(f"Browser profile created with recording parameters:")
        print(f"  record_video_dir: {getattr(browser_profile, 'record_video_dir', None)}")
        print(f"  record_har_path: {getattr(browser_profile, 'record_har_path', None)}")
        print(f"  traces_dir: {getattr(browser_profile, 'traces_dir', None)}")
        ...
        if hasattr(agent, 'browser_profile'):
            ...
            print(f"  agent.browser_profile.record_video_dir: {getattr(bp, 'record_video_dir', None)}")
            print(f"  agent.browser_profile.record_har_path: {getattr(bp, 'record_har_path', None)}")
            print(f"  agent.browser_profile.traces_dir: {getattr(bp, 'traces_dir', None)}")
